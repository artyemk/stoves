...
_bs4 = '<li class="page-item active"><a style="border-color:#fa783c; background-color:#fa783c;" class="page-link">{0} \
...
_bs4 = '<nav aria-label="..." style="display:table; margin: 0 auto;"><ul class="pagination{0}{1}">'
